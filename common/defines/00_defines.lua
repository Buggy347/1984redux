...
NDiplomacy = {
	...
	BASE_IMPROVE_RELATION_COST = 500,                -- Political power cost to initiate relation improvement
	...
	BASE_IMPROVE_RELATION_DIFFERENT_IDEOLOGY_GROUP_MAINTAIN_COST = 1.0,    -- Political power cost each update when boosting relations with nation of different ideology
	...
	IDEOLOGY_JOIN_FACTION_MIN_LEVEL = 0.8,			-- ideology limit required to join faction
	JOIN_FACTION_LIMIT_CHANGE_AT_WAR = 0.7,			-- if in defensive war this or your modifier is counted as limit to join factions (so if you have 80% join limit this now means you can join at 50%)
...
NAI = {
	...
	DIPLOMACY_FACTION_WRONG_IDEOLOGY_PENALTY = 80, -- AI penalty for diplomatic faction acitons between nations of different ideologies
